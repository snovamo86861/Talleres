...
import static centralpacientes.mundo.PacienteKt.HOMBRE;
import static centralpacientes.mundo.PacienteKt.MUJER;
...
public class PanelInformacionPaciente extends JPanel {
    ...
    public PanelInformacionPaciente() {
        ...
        barraDesplazamientoAreaHistoria.setPreferredSize(new Dimension(200, 300));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 5;
     ...
     */
    public void cambiarInformacionComboClinicas(ArrayList<String> clinicas) {
    ...
    public void mostrarInformacionPaciente(Paciente paciente) {
        ...
        textoCodigo.setText(Integer.toString(paciente.getCodigo()));
        areaInformacionMedica.setText(paciente.getInformacionMedica());
        comboClinicas.setSelectedItem(paciente.getClinica());
